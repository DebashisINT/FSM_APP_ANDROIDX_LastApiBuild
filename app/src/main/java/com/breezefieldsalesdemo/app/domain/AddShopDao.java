...
//    void insertOrUpdateShop(long id, String title, String url);
    ...
    @Query("update shop_detail\n" +
            "set jobTitle=:jobTitle,companyName_id=:companyName_id,companyName=:companyName, owner_email=:ownerEmailId, owner_contact_number=:ownerContactNumber, address=:address, pin_code=:pinCode, shopLat=:shopLat, shopLong=:shopLong, crm_assignTo=:crm_assignTo, crm_assignTo_ID=:crm_assignTo_ID, crm_type=:crm_type, crm_type_ID=:crm_type_ID, crm_status=:crm_status, crm_source=:crm_source, crm_source_ID=:crm_source_ID, remarks=:remarks, amount=:amount, crm_stage=:crm_stage, crm_stage_ID=:crm_stage_ID, crm_reference=:crm_reference, crm_reference_ID=:crm_reference_ID, crm_reference_ID_type=:crm_reference_ID_type, crm_saved_from=:crm_saved_from, isEditUploaded=:isEditUploaded,whatsappNoForCustomer=:whatsappNoForCustomer" +
            " where shop_id =:shopId ")
    public int updateContactDtls(String shopId,String companyName_id,String companyName,String jobTitle,String ownerEmailId,String ownerContactNumber,String address,String pinCode,Double shopLat,Double shopLong,
